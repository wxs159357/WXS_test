unit U_WIRINGF_ERROR;

interface

uses System.Classes, U_CKM_DEVICE, System.SysUtils, U_PUB_FUN;
...
type
  ...
  /// 接线错误
  /// </summary>
  TWIRINGF_ERROR = class(TCKM_DEVICE)
  private
...
constructor TWIRINGF_ERROR.Create(AOwner: TComponent);
begin
  inherited;
  FPhaseType := ptfThree;
...
var
  aBytes : TBytes;
begin
  aBytes := StrToBytes(Trim(Value));


  if Length(aBytes) <> 10 then
    aBytes := StrToBytes('3A 00 00 00 00 0C E6 00 CC 40');
